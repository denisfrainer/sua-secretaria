...
export default function GoogleLoginButton() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Note: Not setting isLoading(false) here on success to prevent UI flicker
      // before redirecting to the callback route
    } catch (error) {
  ...
  return (
    <button
      ...
      className={`
        ...
        hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200
    ...
    >
      ...
      {isLoading ? 'Redirecionando...' : 'Registre-se com o Google'}
    </button>
  );
}
