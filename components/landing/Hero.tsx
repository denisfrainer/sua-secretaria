    ...
    <section className="pt-32 pb-16 md:pt-48 md:pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* 1. Headline - Always first on mobile, top-left on desktop */}
          ...
          {/* 2. Image - Second on mobile, spans right column on desktop */}
          ...
          {/* 3. CTA - Third on mobile, bottom-left on desktop */}
          <div className="text-center md:text-left md:col-start-1 md:row-start-2 flex items-start justify-center md:justify-start">
            <Link
              href="/login"
