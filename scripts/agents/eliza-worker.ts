...
// ==============================================================
// 🚀 BOOT: IMMORTAL POLLING ENGINE
// ==============================================================
// This process now runs as a pure background worker. 
// Webhook ingestion has been moved to the Next.js API Gateway.

console.log('🚀 [BOOT] Eliza Polling Engine starting...');
pollLeads(); // Start the immortal recursive loop