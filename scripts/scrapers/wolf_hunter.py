...
def run_hunter():
    ...
    for neighborhood in neighborhoods:
        ...
        # Prompt atualizado para 15 clínicas
        prompt = (
        ...
        print(f"🔎 Acionando Google Maps via Gemini para {niche_query}...")
        ...
        try:
            ...
            if not leads_data:
                print(f"⚠️ A extração para {neighborhood} falhou ou retornou vazio.")
                continue
            ...
            print(f"❌ ERRO no Hunter para {neighborhood}: {str(e)}")
        
        print(f"⏳ Aguardando 5 segundos para o próximo bairro...")
        time.sleep(5)

    print("\n🏁 Mineração Geográfica concluída!")
